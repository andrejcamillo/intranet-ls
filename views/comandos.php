...
<head>
	...
	<meta charset="UTF-8">
        ...
        <link rel="shortcut icon" href="..\img\izi.jpg" type="..\img\izi.jpg" />
    ...
    <br>
      <div class="conteudo_comandos">
       		<div class="conteudo_comandos_int">
       			<h1 align="center">COMANDO PARA OS PIÁ<br></h1><small id="emailHelp" class="form-text small_text"><b>Caso o comando possua aspas simples, coloque mais uma aspas simples para salvar corretamente na base de dados :)</b></small><br>
       		    ...
       		    <form action="salva_cod.php" method="post"><br>
                       ...
                       <div class="form-group">
						...
						<input type=image src="../img/izi.jpg" class="img_izi" width="80">
                 </form>
                 <hr>
		...
		<div class="tabela_comandos">
			<div class="tabela_comandos_int">
                   ...
                   // <a href="#modal_excluir" data-toggle="modal" data-target="#modal_excluir"><img src="imgs/x-button.png"></a>
                    echo '<td><img src="../img/x-button.png"></td>';
								   	echo '<tr>';
